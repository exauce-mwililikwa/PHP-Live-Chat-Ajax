		...
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					...
					<div id="bottom-bar">	
						<button ><a href="signout.php" style="text-decoration: none;"><i class="fa fa-user-plus fa-fw" aria-hidden="true"></i> <span>Add contact</span></a></button>
				...
				<div class="content" id="content"> 
					...
					<div class="message-input" id="replySection">				
						<div class="message-input" id="replyContainer">
							<div class="wrap">
								<input type="text" class="chatMessage" id="chatMessage<?php echo $currentSession; ?>" placeholder="Entrer le message ...." />
